                ...
                var t = e.symbol,
                    ...
                    s = function(e, t) {
                        switch (e.startsWith("/swap") ? "/swap" : e.startsWith("/add") ? "/add" : e.startsWith("/remove") ? "/remove" : e.startsWith("/teams") ? "/teams" : e.startsWith("/voting/proposal") && "/voting/proposal/create" !== e ? "/voting/proposal" : e) {
                            ...
                            case "/info":
                                return { title: "".concat(t("Overview"), " | ").concat(t("SALIX ( SLX ) Info & Analytics")), description: "View statistics for AntiqueSwap exchanges." };
                            case "/info/pools":
                            case "/info/tokens":
                                return { title: "".concat(t("Pools"), " | ").concat(t("SALIX ( SLX ) Info & Analytics")), description: "View statistics for AntiqueSwap exchanges." };
                            default:
                                return null
                        }
                    }(a, n) || {},
